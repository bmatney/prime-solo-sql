...
-- Update all records with an account balance of 0.00
...
-- 5. Get the username and account balance of the 3 users with
-- the highest balances, sort highest to lowest balance. NOTE: Research LIMIT
